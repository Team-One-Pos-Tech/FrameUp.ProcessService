# Variáveis
$downloadUrl = "https://github.com/ffbinaries/ffbinaries-prebuilt/releases/download/v6.1/ffprobe-6.1-win-64.zip"
$targetDir = ".\Windows"
$zipFile = Join-Path $targetDir "ffprobe-6.1-win-64.zip"
